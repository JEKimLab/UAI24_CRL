...
from representation.loss.confidence_penalty import ConfidencePenalty
...
class VanillaMia_CP(VanillaMia):
    def __init__(
            self,
        ...
        super(VanillaMia_CP, self).__init__(
            target_model, shadow_models, attack_model,
            target_train, target_test, shadow_train_list, shadow_test_list,
    ...
    def train_target_model(self, args):
        ...
        ''' others '''
        criterion = ConfidencePenalty(alpha=self.loss_confs['alpha']).to(args.device)
