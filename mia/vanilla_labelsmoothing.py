...
from representation.loss.labelsmoothing import LabelSmoothingCrossEntropy
...
class VanillaMia_LS(VanillaMia):
    def __init__(
            self,
        ...
        super(VanillaMia_LS, self).__init__(
            target_model, shadow_models, attack_model,
            target_train, target_test, shadow_train_list, shadow_test_list,
    ...
    def train_target_model(self, args):
        ...
        ''' others '''
        criterion = LabelSmoothingCrossEntropy(epsilon=self.loss_confs['epsilon']).to(args.device)
