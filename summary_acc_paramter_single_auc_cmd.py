...
if __name__ == '__main__':
    ...
    # meta_path = f"/2nd_disk/experiment/pfr/{loss_conf}/{dataset_name}/{arch_conf}"
    meta_path = f"/2nd_disk/exp/{loss_conf}/{dataset_name}/{arch_conf}"
    # meta_path = f"/mnt/beegfs/xfang23/saves1/{loss_conf}/{dataset_name}/{arch_conf}"
