...
if __name__ == '__main__':
    ...
    learn_method = 'centerloss'
    loss_conf = 'cl_resnet_001'
    split_ratio = 0.0
    # others
    num_runs = 30
    # path
    base_path = f'/2nd_disk/expcl/{loss_conf}/{dataset_name}/{arch_conf}/{learn_method}_{attack_method}'
    save_base_path = f'/2nd_disk/result/pfr/{dataset_name}'
