...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.residual_function = nn.Sequential(
            ...
            nn.GroupNorm(num_groups=32, num_channels=out_channels * BasicBlock.expansion)
        )
...
class BottleNeck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.residual_function = nn.Sequential(
            ...
            nn.GroupNorm(num_groups=32, num_channels=out_channels * BottleNeck.expansion),
        )
...
if __name__ == '__main__':
    net = resnet(arch = 'resnet18')
    inputs = torch.randn(1, 3, 32, 32)
    net(inputs)

    arch = 'resnet50'

    from fvcore.nn import FlopCountAnalysis, flop_count_table, parameter_count, flop_count
