...
class MIADataset(Dataset):
    ...
    def __init__(
            ...
            data_train_sensitivity_list, data_test_sensitivity_list,
        ...
        ''' input sensitivity '''
        self.data_sensi = []
        self.data_sensi += data_train_sensitivity_list
        self.data_sensi += data_test_sensitivity_list
        ''' classes '''
        self.label = []
    ...
    def __getitem__(self, index):
        ...
        data_p3 = self.data_sensi[index]
        data = torch.cat((data_p1, data_p2, data_p3), 0)
